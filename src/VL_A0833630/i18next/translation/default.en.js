  ...
  tab3: {
    ...
    slide3: {
      ...
      dropzone: [
        {
          ...
          label1: "Water Sample One",
          label: "1st drop area of six water sample",
          altext: "Pipette dropped on 1st water sample",
        },
        {
          target: "WaterSample2",
          id: "water_sample2",
          class: "dropElement2",
          toastMsg: "<b>Correct!</b>",
          label1: "Water Sample Two",
          label: "2nd drop area of six water sample",
          altext: "Pipette dropped on 2nd water sample",
        },
        {
          target: "WaterSample3",
          id: "water_sample3",
          class: "dropElement3",
          toastMsg: "<b>Correct!</b>",
          label1: "Water Sample Three",
          label: "3rd drop area of six water sample",
          altext: "Pipette dropped on 3rd water sample",
        },
        {
          target: "WaterSample4",
          id: "water_sample4",
          class: "dropElement4",
          toastMsg: "<b>Correct!</b>",
          label1: "Water Sample Four",
          label: "4th drop area of six water sample",
          altext: "Pipette dropped on 4th water sample",
        },
        {
          target: "WaterSample5",
          id: "water_sample5",
          class: "dropElement5",
          toastMsg: "<b>Correct!</b>",
          label1: "Water Sample Five",
          label: "5th drop area of six water sample",
          altext: "Pipette dropped on 5th water sample",
        },
        {
          target: "WaterSample6",
          id: "water_sample6",
          class: "dropElement6",
          toastMsg: "<b>Correct!</b>",
          label1: "Water Sample Six",
          label: "6th drop area of six water sample",
          altext: "Pipette dropped on 6th water sample",
        },
      ],
      commonDropZone: [
        {
      ...
      lables: [
        ...
        {
          lable: "1",
          class: "water_sample_lable1",
        },
        {
          lable: "2",
          class: "water_sample_lable2",
        },
        {
          lable: "3",
          class: "water_sample_lable3",
        },
        {
          lable: "4",
          class: "water_sample_lable4",
        },
        {
          lable: "5",
          class: "water_sample_lable5",
        },
        {
          lable: "6",
